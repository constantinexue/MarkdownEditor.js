// https://raw.github.com/swenson/ace_spell_check_js/master/spellcheck_ace.js
// You also need to load in typo.js and jquery.js

// You should configure these classes.
var editor = "#ace-edit"; // This should be the id of your editor element.
var lang = "en_US";
var dicPath = "./vendor/en_US.dic";
var affPath = "./vendor/en_US.aff";
...
function misspelled(line) {
    // http://stackoverflow.com/questions/13955904/regex-replace-all-commas-with-value
    ...
    for (word in words) {
        ...
        if (!dictionary.check(checkWord)) {
            var array_of_suggestions = dictionary.suggest(checkWord);
